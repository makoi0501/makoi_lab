...
static const _PixelCommands_type_support_symbol_names_t _PixelCommands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interbotix_rpi_msgs, msg, PixelCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interbotix_rpi_msgs, msg, PixelCommands)),
  }
};
...
{
  return &::interbotix_rpi_msgs::msg::rosidl_typesupport_cpp::PixelCommands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interbotix_rpi_msgs, msg, PixelCommands)() {
  return get_message_type_support_handle<interbotix_rpi_msgs::msg::PixelCommands>();
}
