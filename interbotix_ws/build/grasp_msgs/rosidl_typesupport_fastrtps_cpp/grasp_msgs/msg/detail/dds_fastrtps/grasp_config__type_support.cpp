...
#include "grasp_msgs/msg/detail/grasp_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const grasp_msgs::msg::GraspConfig *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<grasp_msgs::msg::GraspConfig *>(
    untyped_ros_message);
...
{
  return &grasp_msgs::msg::typesupport_fastrtps_cpp::_GraspConfig__handle;
}
