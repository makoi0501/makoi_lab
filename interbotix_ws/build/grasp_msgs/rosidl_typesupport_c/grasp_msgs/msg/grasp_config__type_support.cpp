...
#include "grasp_msgs/msg/detail/grasp_config__type_support.h"
...
static const _GraspConfig_type_support_symbol_names_t _GraspConfig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grasp_msgs, msg, GraspConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, grasp_msgs, msg, GraspConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, grasp_msgs, msg, GraspConfig)() {
  return &::grasp_msgs::msg::rosidl_typesupport_c::GraspConfig_message_type_support_handle;
}
