...
bool
grasp_msgs__msg__SamplesMsg__are_equal(const grasp_msgs__msg__SamplesMsg * lhs, const grasp_msgs__msg__SamplesMsg * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
grasp_msgs__msg__SamplesMsg__copy(
  const grasp_msgs__msg__SamplesMsg * input,
  grasp_msgs__msg__SamplesMsg * output)
{
  if (!input || !output) {
    return false;
  }
...
grasp_msgs__msg__SamplesMsg__create()
{
  ...
  grasp_msgs__msg__SamplesMsg * msg = (grasp_msgs__msg__SamplesMsg *)allocator.allocate(sizeof(grasp_msgs__msg__SamplesMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
...
grasp_msgs__msg__SamplesMsg__Sequence__init(grasp_msgs__msg__SamplesMsg__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (grasp_msgs__msg__SamplesMsg *)allocator.zero_allocate(size, sizeof(grasp_msgs__msg__SamplesMsg), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  grasp_msgs__msg__SamplesMsg__Sequence * array = (grasp_msgs__msg__SamplesMsg__Sequence *)allocator.allocate(sizeof(grasp_msgs__msg__SamplesMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
grasp_msgs__msg__SamplesMsg__Sequence__are_equal(const grasp_msgs__msg__SamplesMsg__Sequence * lhs, const grasp_msgs__msg__SamplesMsg__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!grasp_msgs__msg__SamplesMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
grasp_msgs__msg__SamplesMsg__Sequence__copy(
  const grasp_msgs__msg__SamplesMsg__Sequence * input,
  grasp_msgs__msg__SamplesMsg__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(grasp_msgs__msg__SamplesMsg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    grasp_msgs__msg__SamplesMsg * data =
      (grasp_msgs__msg__SamplesMsg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!grasp_msgs__msg__SamplesMsg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          grasp_msgs__msg__SamplesMsg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!grasp_msgs__msg__SamplesMsg__copy(
