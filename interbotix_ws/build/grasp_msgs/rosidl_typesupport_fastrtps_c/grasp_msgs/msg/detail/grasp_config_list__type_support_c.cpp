...
#include "grasp_msgs/msg/detail/grasp_config_list__rosidl_typesupport_fastrtps_c.h"
...
#include "grasp_msgs/msg/detail/grasp_config__functions.h"  // grasps
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: grasps
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, grasp_msgs, msg, GraspConfig
      )()->data);
...
static size_t _GraspConfigList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_grasp_msgs__msg__GraspConfigList(
