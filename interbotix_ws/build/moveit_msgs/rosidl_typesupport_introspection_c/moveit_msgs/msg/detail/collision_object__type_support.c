...
static rosidl_typesupport_introspection_c__MessageMember moveit_msgs__msg__CollisionObject__rosidl_typesupport_introspection_c__CollisionObject_message_member_array[10] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, CollisionObject)() {
  ...
  moveit_msgs__msg__CollisionObject__rosidl_typesupport_introspection_c__CollisionObject_message_member_array[2].members_ =
