...
static const _ObjectType_type_support_symbol_names_t _ObjectType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, ObjectType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, moveit_msgs, msg, ObjectType)),
  }
};
...
{
  return &::moveit_msgs::msg::rosidl_typesupport_cpp::ObjectType_message_type_support_handle;
}
