...
#include "moveit_msgs/msg/detail/object_type__type_support.h"
...
static const _ObjectType_type_support_symbol_names_t _ObjectType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, msg, ObjectType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, ObjectType)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, msg, ObjectType)() {
  return &::moveit_msgs::msg::rosidl_typesupport_c::ObjectType_message_type_support_handle;
}
