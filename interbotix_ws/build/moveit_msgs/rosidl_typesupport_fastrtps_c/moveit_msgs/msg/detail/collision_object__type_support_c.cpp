...
#include "geometry_msgs/msg/detail/pose__functions.h"  // mesh_poses, plane_poses, primitive_poses
#include "moveit_msgs/msg/detail/object_type__functions.h"  // type
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: type
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, moveit_msgs, msg, ObjectType
      )()->data);
    if (!callbacks->cdr_serialize(
