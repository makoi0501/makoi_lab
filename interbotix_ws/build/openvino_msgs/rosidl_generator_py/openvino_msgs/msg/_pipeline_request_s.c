...
bool openvino_msgs__msg__pipeline_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("openvino_msgs.msg._pipeline_request.PipelineRequest", full_classname_dest, 51) == 0);
  }
  openvino_msgs__msg__PipelineRequest * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PipelineRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("openvino_msgs.msg._pipeline_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PipelineRequest");
