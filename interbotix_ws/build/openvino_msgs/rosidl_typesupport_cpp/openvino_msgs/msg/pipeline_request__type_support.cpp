...
static const _PipelineRequest_type_support_symbol_names_t _PipelineRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, openvino_msgs, msg, PipelineRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, openvino_msgs, msg, PipelineRequest)),
  }
};
...
{
  return &::openvino_msgs::msg::rosidl_typesupport_cpp::PipelineRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, openvino_msgs, msg, PipelineRequest)() {
  return get_message_type_support_handle<openvino_msgs::msg::PipelineRequest>();
}
