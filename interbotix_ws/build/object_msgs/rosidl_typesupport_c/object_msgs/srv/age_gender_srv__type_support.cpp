...
static const _AgeGenderSrv_Request_type_support_symbol_names_t _AgeGenderSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, object_msgs, srv, AgeGenderSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, object_msgs, srv, AgeGenderSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, object_msgs, srv, AgeGenderSrv_Request)() {
  return &::object_msgs::srv::rosidl_typesupport_c::AgeGenderSrv_Request_message_type_support_handle;
}
...
static const _AgeGenderSrv_Response_type_support_symbol_names_t _AgeGenderSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, object_msgs, srv, AgeGenderSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, object_msgs, srv, AgeGenderSrv_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, object_msgs, srv, AgeGenderSrv_Response)() {
  return &::object_msgs::srv::rosidl_typesupport_c::AgeGenderSrv_Response_message_type_support_handle;
}
...
static const _AgeGenderSrv_type_support_symbol_names_t _AgeGenderSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, object_msgs, srv, AgeGenderSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, object_msgs, srv, AgeGenderSrv)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, object_msgs, srv, AgeGenderSrv)() {
  return &::object_msgs::srv::rosidl_typesupport_c::AgeGenderSrv_service_type_support_handle;
}
