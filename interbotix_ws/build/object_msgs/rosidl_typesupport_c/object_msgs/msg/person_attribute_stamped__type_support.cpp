...
static const _PersonAttributeStamped_type_support_symbol_names_t _PersonAttributeStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, object_msgs, msg, PersonAttributeStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, object_msgs, msg, PersonAttributeStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, object_msgs, msg, PersonAttributeStamped)() {
  return &::object_msgs::msg::rosidl_typesupport_c::PersonAttributeStamped_message_type_support_handle;
}
