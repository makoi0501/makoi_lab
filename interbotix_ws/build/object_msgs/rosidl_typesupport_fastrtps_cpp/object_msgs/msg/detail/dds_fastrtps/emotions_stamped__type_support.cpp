...
#include "object_msgs/msg/detail/emotions_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _EmotionsStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EmotionsStamped(full_bounded, is_plain, 0);
