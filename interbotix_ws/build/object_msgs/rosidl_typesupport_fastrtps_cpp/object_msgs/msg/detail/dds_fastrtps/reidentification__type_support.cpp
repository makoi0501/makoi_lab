...
#include "object_msgs/msg/detail/reidentification__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _Reidentification__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Reidentification(full_bounded, is_plain, 0);
