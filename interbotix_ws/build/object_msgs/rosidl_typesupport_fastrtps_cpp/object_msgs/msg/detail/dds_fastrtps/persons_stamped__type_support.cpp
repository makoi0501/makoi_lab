...
#include "object_msgs/msg/detail/persons_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _PersonsStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PersonsStamped(full_bounded, is_plain, 0);
