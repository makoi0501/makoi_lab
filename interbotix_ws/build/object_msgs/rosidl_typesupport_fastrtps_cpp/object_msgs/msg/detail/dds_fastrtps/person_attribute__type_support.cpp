...
#include "object_msgs/msg/detail/person_attribute__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _PersonAttribute__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PersonAttribute(full_bounded, is_plain, 0);
