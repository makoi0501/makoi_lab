...
#include "object_msgs/srv/detail/detect_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const object_msgs::srv::DetectObject_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  object_msgs::srv::DetectObject_Request & ros_message)
{
  // Member: image_path
  cdr >> ros_message.image_path;
...
{
  auto typed_message =
    static_cast<const object_msgs::srv::DetectObject_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<object_msgs::srv::DetectObject_Request *>(
    untyped_ros_message);
...
{
  return &object_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_msgs, srv, DetectObject_Request)() {
  return &object_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Request__handle;
}
...
{
bool cdr_serialize(
  const object_msgs::msg::ObjectsInBoxes &,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_object_msgs
cdr_serialize(
  const object_msgs::srv::DetectObject_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: objects
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  object_msgs::srv::DetectObject_Response & ros_message)
{
  // Member: objects
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        object_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectsInBoxes(
...
{
  auto typed_message =
    static_cast<const object_msgs::srv::DetectObject_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<object_msgs::srv::DetectObject_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &object_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_msgs, srv, DetectObject_Response)() {
  return &object_msgs::srv::typesupport_fastrtps_cpp::_DetectObject_Response__handle;
}
...
{
  return &object_msgs::srv::typesupport_fastrtps_cpp::_DetectObject__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_msgs, srv, DetectObject)() {
  return &object_msgs::srv::typesupport_fastrtps_cpp::_DetectObject__handle;
}
