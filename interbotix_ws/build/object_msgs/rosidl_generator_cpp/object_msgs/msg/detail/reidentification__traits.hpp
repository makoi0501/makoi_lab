...
#ifndef OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION__TRAITS_HPP_
#define OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION__TRAITS_HPP_
...
inline std::string to_yaml(const Reidentification & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const object_msgs::msg::Reidentification & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const object_msgs::msg::Reidentification & msg)
{
...
template<>
inline const char * name<object_msgs::msg::Reidentification>()
{
  return "object_msgs/msg/Reidentification";
}
...
template<>
struct is_message<object_msgs::msg::Reidentification>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION__TRAITS_HPP_
