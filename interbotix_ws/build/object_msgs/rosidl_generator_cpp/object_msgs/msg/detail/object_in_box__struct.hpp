...
#ifndef OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_BOX__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_BOX__STRUCT_HPP_
...
struct ObjectInBox_
{
  ...
  explicit ObjectInBox_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : object(_init),
    roi(_init)
  {
    (void)_init;
  ...
  explicit ObjectInBox_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : object(_alloc, _init),
    roi(_alloc, _init)
  {
    (void)_init;
...
#endif  // OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_BOX__STRUCT_HPP_
