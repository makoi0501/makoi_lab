...
#ifndef OBJECT_MSGS__MSG__DETAIL__LANDMARK_STAMPED__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__LANDMARK_STAMPED__STRUCT_HPP_
...
struct LandmarkStamped_
{
  ...
  explicit LandmarkStamped_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit LandmarkStamped_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _landmarks_type =
    std::vector<object_msgs::msg::Landmark_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Landmark_<ContainerAllocator>>>;
  ...
  Type & set__landmarks(
    const std::vector<object_msgs::msg::Landmark_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Landmark_<ContainerAllocator>>> & _arg)
  {
    this->landmarks = _arg;
    return *this;
  }
...
#endif  // OBJECT_MSGS__MSG__DETAIL__LANDMARK_STAMPED__STRUCT_HPP_
