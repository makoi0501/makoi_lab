...
#ifndef OBJECT_MSGS__MSG__DETAIL__LICENSE_PLATE__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__LICENSE_PLATE__STRUCT_HPP_
...
struct LicensePlate_
{
  ...
  explicit LicensePlate_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit LicensePlate_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : license(_alloc),
    roi(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OBJECT_MSGS__MSG__DETAIL__LICENSE_PLATE__STRUCT_HPP_
