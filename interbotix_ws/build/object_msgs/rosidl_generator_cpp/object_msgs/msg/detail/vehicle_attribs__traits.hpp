...
#ifndef OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS__TRAITS_HPP_
#define OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS__TRAITS_HPP_
...
inline std::string to_yaml(const VehicleAttribs & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const object_msgs::msg::VehicleAttribs & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const object_msgs::msg::VehicleAttribs & msg)
{
...
template<>
inline const char * name<object_msgs::msg::VehicleAttribs>()
{
  return "object_msgs/msg/VehicleAttribs";
}
...
template<>
struct is_message<object_msgs::msg::VehicleAttribs>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS__TRAITS_HPP_
