...
#ifndef OBJECT_MSGS__MSG__DETAIL__PERSONS_STAMPED__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__PERSONS_STAMPED__STRUCT_HPP_
...
struct PersonsStamped_
{
  ...
  explicit PersonsStamped_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit PersonsStamped_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _emotions_type =
    std::vector<object_msgs::msg::Emotion_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Emotion_<ContainerAllocator>>>;
  _emotions_type emotions;
  using _agegenders_type =
    std::vector<object_msgs::msg::AgeGender_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::AgeGender_<ContainerAllocator>>>;
  _agegenders_type agegenders;
  using _headposes_type =
    std::vector<object_msgs::msg::HeadPose_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::HeadPose_<ContainerAllocator>>>;
  ...
  Type & set__emotions(
    const std::vector<object_msgs::msg::Emotion_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Emotion_<ContainerAllocator>>> & _arg)
  {
    this->emotions = _arg;
    return *this;
  }
  Type & set__agegenders(
    const std::vector<object_msgs::msg::AgeGender_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::AgeGender_<ContainerAllocator>>> & _arg)
  {
    this->agegenders = _arg;
    return *this;
  }
  Type & set__headposes(
    const std::vector<object_msgs::msg::HeadPose_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::HeadPose_<ContainerAllocator>>> & _arg)
  {
    this->headposes = _arg;
    return *this;
  }
...
#endif  // OBJECT_MSGS__MSG__DETAIL__PERSONS_STAMPED__STRUCT_HPP_
