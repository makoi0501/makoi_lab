...
#ifndef OBJECT_MSGS__MSG__DETAIL__PERSON_ATTRIBUTE__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__PERSON_ATTRIBUTE__STRUCT_HPP_
...
struct PersonAttribute_
{
  ...
  explicit PersonAttribute_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit PersonAttribute_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : attribute(_alloc),
    roi(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OBJECT_MSGS__MSG__DETAIL__PERSON_ATTRIBUTE__STRUCT_HPP_
