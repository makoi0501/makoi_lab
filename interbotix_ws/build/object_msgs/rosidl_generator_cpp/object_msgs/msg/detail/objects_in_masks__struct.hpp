...
#ifndef OBJECT_MSGS__MSG__DETAIL__OBJECTS_IN_MASKS__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__OBJECTS_IN_MASKS__STRUCT_HPP_
...
struct ObjectsInMasks_
{
  ...
  explicit ObjectsInMasks_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit ObjectsInMasks_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _objects_vector_type =
    std::vector<object_msgs::msg::ObjectInMask_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::ObjectInMask_<ContainerAllocator>>>;
  ...
  Type & set__objects_vector(
    const std::vector<object_msgs::msg::ObjectInMask_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::ObjectInMask_<ContainerAllocator>>> & _arg)
  {
...
#endif  // OBJECT_MSGS__MSG__DETAIL__OBJECTS_IN_MASKS__STRUCT_HPP_
