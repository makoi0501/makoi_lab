...
#ifndef OBJECT_MSGS__MSG__DETAIL__OBJECTS_IN_BOXES3_D__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__OBJECTS_IN_BOXES3_D__STRUCT_HPP_
...
struct ObjectsInBoxes3D_
{
  ...
  explicit ObjectsInBoxes3D_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit ObjectsInBoxes3D_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _objects_in_boxes_type =
    std::vector<object_msgs::msg::ObjectInBox3D_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::ObjectInBox3D_<ContainerAllocator>>>;
  ...
  Type & set__objects_in_boxes(
    const std::vector<object_msgs::msg::ObjectInBox3D_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::ObjectInBox3D_<ContainerAllocator>>> & _arg)
  {
...
#endif  // OBJECT_MSGS__MSG__DETAIL__OBJECTS_IN_BOXES3_D__STRUCT_HPP_
