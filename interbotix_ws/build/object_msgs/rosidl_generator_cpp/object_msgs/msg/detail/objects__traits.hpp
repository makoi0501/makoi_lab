...
#ifndef OBJECT_MSGS__MSG__DETAIL__OBJECTS__TRAITS_HPP_
#define OBJECT_MSGS__MSG__DETAIL__OBJECTS__TRAITS_HPP_
...
inline void to_yaml(
  const object_msgs::msg::Objects & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const object_msgs::msg::Objects & msg)
{
...
template<>
inline const char * name<object_msgs::msg::Objects>()
{
  return "object_msgs/msg/Objects";
}
...
template<>
struct is_message<object_msgs::msg::Objects>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // OBJECT_MSGS__MSG__DETAIL__OBJECTS__TRAITS_HPP_
