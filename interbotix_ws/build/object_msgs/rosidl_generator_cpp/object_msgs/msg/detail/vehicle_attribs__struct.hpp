...
#ifndef OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS__STRUCT_HPP_
...
struct VehicleAttribs_
{
  ...
  explicit VehicleAttribs_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit VehicleAttribs_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : type(_alloc),
    color(_alloc),
    roi(_alloc, _init)
  {
...
#endif  // OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS__STRUCT_HPP_
