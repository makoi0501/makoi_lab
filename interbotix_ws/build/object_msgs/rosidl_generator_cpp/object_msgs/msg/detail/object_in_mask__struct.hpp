...
#ifndef OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_MASK__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_MASK__STRUCT_HPP_
...
struct ObjectInMask_
{
  ...
  explicit ObjectInMask_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit ObjectInMask_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : object_name(_alloc),
    roi(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_MASK__STRUCT_HPP_
