...
#ifndef OBJECT_MSGS__MSG__DETAIL__EMOTIONS_STAMPED__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__EMOTIONS_STAMPED__STRUCT_HPP_
...
struct EmotionsStamped_
{
  ...
  explicit EmotionsStamped_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit EmotionsStamped_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // OBJECT_MSGS__MSG__DETAIL__EMOTIONS_STAMPED__STRUCT_HPP_
