...
#ifndef OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION__STRUCT_HPP_
...
struct Reidentification_
{
  ...
  explicit Reidentification_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit Reidentification_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : identity(_alloc),
    roi(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION__STRUCT_HPP_
