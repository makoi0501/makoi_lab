...
#ifndef OBJECT_MSGS__MSG__DETAIL__HEAD_POSE_STAMPED__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__HEAD_POSE_STAMPED__STRUCT_HPP_
...
struct HeadPoseStamped_
{
  ...
  explicit HeadPoseStamped_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit HeadPoseStamped_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // OBJECT_MSGS__MSG__DETAIL__HEAD_POSE_STAMPED__STRUCT_HPP_
