...
#include "object_msgs/msg/detail/objects__rosidl_typesupport_fastrtps_c.h"
...
#include "object_msgs/msg/detail/object__functions.h"  // objects_vector
...
using _Objects__ros_msg_type = object_msgs__msg__Objects;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects_vector
  {
    ...
    if (ros_message->objects_vector.data) {
      object_msgs__msg__Object__Sequence__fini(&ros_message->objects_vector);
    }
...
static uint32_t _Objects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_object_msgs__msg__Objects(
...
static size_t _Objects__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_object_msgs__msg__Objects(
