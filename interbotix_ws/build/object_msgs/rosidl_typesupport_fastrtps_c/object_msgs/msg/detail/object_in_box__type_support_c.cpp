...
#include "object_msgs/msg/detail/object_in_box__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectInBox__ros_msg_type = object_msgs__msg__ObjectInBox;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectInBox__ros_msg_type * ros_message = static_cast<const _ObjectInBox__ros_msg_type *>(untyped_ros_message);
  // Field name: object
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectInBox__ros_msg_type * ros_message = static_cast<_ObjectInBox__ros_msg_type *>(untyped_ros_message);
  // Field name: object
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_object_msgs__msg__ObjectInBox(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectInBox__ros_msg_type * ros_message = static_cast<const _ObjectInBox__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectInBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_object_msgs__msg__ObjectInBox(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_object_msgs
size_t max_serialized_size_object_msgs__msg__ObjectInBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ObjectInBox__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_object_msgs__msg__ObjectInBox(
...
static message_type_support_callbacks_t __callbacks_ObjectInBox = {
  "object_msgs::msg",
  "ObjectInBox",
...
static rosidl_message_type_support_t _ObjectInBox__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectInBox,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, object_msgs, msg, ObjectInBox)() {
  return &_ObjectInBox__type_support;
}
