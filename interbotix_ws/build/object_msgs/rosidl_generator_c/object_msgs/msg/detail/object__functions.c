...
bool
object_msgs__msg__Object__are_equal(const object_msgs__msg__Object * lhs, const object_msgs__msg__Object * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
object_msgs__msg__Object__copy(
  const object_msgs__msg__Object * input,
  object_msgs__msg__Object * output)
{
  if (!input || !output) {
    return false;
  }
...
object_msgs__msg__Object__create()
{
  ...
  object_msgs__msg__Object * msg = (object_msgs__msg__Object *)allocator.allocate(sizeof(object_msgs__msg__Object), allocator.state);
  if (!msg) {
    return NULL;
  }
...
object_msgs__msg__Object__Sequence__init(object_msgs__msg__Object__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (object_msgs__msg__Object *)allocator.zero_allocate(size, sizeof(object_msgs__msg__Object), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__msg__Object__Sequence * array = (object_msgs__msg__Object__Sequence *)allocator.allocate(sizeof(object_msgs__msg__Object__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
object_msgs__msg__Object__Sequence__are_equal(const object_msgs__msg__Object__Sequence * lhs, const object_msgs__msg__Object__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!object_msgs__msg__Object__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
object_msgs__msg__Object__Sequence__copy(
  const object_msgs__msg__Object__Sequence * input,
  object_msgs__msg__Object__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(object_msgs__msg__Object);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    object_msgs__msg__Object * data =
      (object_msgs__msg__Object *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!object_msgs__msg__Object__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          object_msgs__msg__Object__fini(&output->data[i]);
        }
        return false;
      }
    }
