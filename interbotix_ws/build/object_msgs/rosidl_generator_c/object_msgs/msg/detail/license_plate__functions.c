...
object_msgs__msg__LicensePlate__init(object_msgs__msg__LicensePlate * msg)
{
  ...
  // license
  if (!rosidl_runtime_c__String__init(&msg->license)) {
...
object_msgs__msg__LicensePlate__fini(object_msgs__msg__LicensePlate * msg)
{
  ...
  // license
  rosidl_runtime_c__String__fini(&msg->license);
  // roi
  sensor_msgs__msg__RegionOfInterest__fini(&msg->roi);
}

bool
object_msgs__msg__LicensePlate__are_equal(const object_msgs__msg__LicensePlate * lhs, const object_msgs__msg__LicensePlate * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
object_msgs__msg__LicensePlate__copy(
  const object_msgs__msg__LicensePlate * input,
  object_msgs__msg__LicensePlate * output)
{
  if (!input || !output) {
    return false;
  }
...
object_msgs__msg__LicensePlate__create()
{
  ...
  object_msgs__msg__LicensePlate * msg = (object_msgs__msg__LicensePlate *)allocator.allocate(sizeof(object_msgs__msg__LicensePlate), allocator.state);
  if (!msg) {
    return NULL;
  }
...
object_msgs__msg__LicensePlate__Sequence__init(object_msgs__msg__LicensePlate__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (object_msgs__msg__LicensePlate *)allocator.zero_allocate(size, sizeof(object_msgs__msg__LicensePlate), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__msg__LicensePlate__Sequence * array = (object_msgs__msg__LicensePlate__Sequence *)allocator.allocate(sizeof(object_msgs__msg__LicensePlate__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
object_msgs__msg__LicensePlate__Sequence__are_equal(const object_msgs__msg__LicensePlate__Sequence * lhs, const object_msgs__msg__LicensePlate__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!object_msgs__msg__LicensePlate__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
object_msgs__msg__LicensePlate__Sequence__copy(
  const object_msgs__msg__LicensePlate__Sequence * input,
  object_msgs__msg__LicensePlate__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(object_msgs__msg__LicensePlate);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    object_msgs__msg__LicensePlate * data =
      (object_msgs__msg__LicensePlate *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!object_msgs__msg__LicensePlate__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          object_msgs__msg__LicensePlate__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!object_msgs__msg__LicensePlate__copy(
