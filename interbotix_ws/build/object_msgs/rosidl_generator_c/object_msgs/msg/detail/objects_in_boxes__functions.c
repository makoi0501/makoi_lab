...
object_msgs__msg__ObjectsInBoxes__create()
{
  ...
  object_msgs__msg__ObjectsInBoxes * msg = (object_msgs__msg__ObjectsInBoxes *)allocator.allocate(sizeof(object_msgs__msg__ObjectsInBoxes), allocator.state);
  if (!msg) {
    return NULL;
  }
...
object_msgs__msg__ObjectsInBoxes__Sequence__init(object_msgs__msg__ObjectsInBoxes__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (object_msgs__msg__ObjectsInBoxes *)allocator.zero_allocate(size, sizeof(object_msgs__msg__ObjectsInBoxes), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__msg__ObjectsInBoxes__Sequence * array = (object_msgs__msg__ObjectsInBoxes__Sequence *)allocator.allocate(sizeof(object_msgs__msg__ObjectsInBoxes__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
object_msgs__msg__ObjectsInBoxes__Sequence__are_equal(const object_msgs__msg__ObjectsInBoxes__Sequence * lhs, const object_msgs__msg__ObjectsInBoxes__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!object_msgs__msg__ObjectsInBoxes__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  object_msgs__msg__ObjectsInBoxes__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(object_msgs__msg__ObjectsInBoxes);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    object_msgs__msg__ObjectsInBoxes * data =
      (object_msgs__msg__ObjectsInBoxes *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!object_msgs__msg__ObjectsInBoxes__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          object_msgs__msg__ObjectsInBoxes__fini(&output->data[i]);
        }
        return false;
      }
    }
