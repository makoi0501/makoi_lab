...
bool
object_msgs__msg__PersonAttributeStamped__are_equal(const object_msgs__msg__PersonAttributeStamped * lhs, const object_msgs__msg__PersonAttributeStamped * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // attributes
  if (!object_msgs__msg__PersonAttribute__Sequence__are_equal(
...
bool
object_msgs__msg__PersonAttributeStamped__copy(
  const object_msgs__msg__PersonAttributeStamped * input,
  object_msgs__msg__PersonAttributeStamped * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // attributes
  if (!object_msgs__msg__PersonAttribute__Sequence__copy(
...
object_msgs__msg__PersonAttributeStamped__create()
{
  ...
  object_msgs__msg__PersonAttributeStamped * msg = (object_msgs__msg__PersonAttributeStamped *)allocator.allocate(sizeof(object_msgs__msg__PersonAttributeStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
...
object_msgs__msg__PersonAttributeStamped__Sequence__init(object_msgs__msg__PersonAttributeStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (object_msgs__msg__PersonAttributeStamped *)allocator.zero_allocate(size, sizeof(object_msgs__msg__PersonAttributeStamped), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__msg__PersonAttributeStamped__Sequence * array = (object_msgs__msg__PersonAttributeStamped__Sequence *)allocator.allocate(sizeof(object_msgs__msg__PersonAttributeStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
object_msgs__msg__PersonAttributeStamped__Sequence__are_equal(const object_msgs__msg__PersonAttributeStamped__Sequence * lhs, const object_msgs__msg__PersonAttributeStamped__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!object_msgs__msg__PersonAttributeStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
object_msgs__msg__PersonAttributeStamped__Sequence__copy(
  const object_msgs__msg__PersonAttributeStamped__Sequence * input,
  object_msgs__msg__PersonAttributeStamped__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(object_msgs__msg__PersonAttributeStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    object_msgs__msg__PersonAttributeStamped * data =
      (object_msgs__msg__PersonAttributeStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!object_msgs__msg__PersonAttributeStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          object_msgs__msg__PersonAttributeStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!object_msgs__msg__PersonAttributeStamped__copy(
