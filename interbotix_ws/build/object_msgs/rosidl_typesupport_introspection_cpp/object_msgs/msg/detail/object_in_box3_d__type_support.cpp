...
void ObjectInBox3D_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) object_msgs::msg::ObjectInBox3D(_init);
}

void ObjectInBox3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_msgs::msg::ObjectInBox3D *>(message_memory);
  typed_message->~ObjectInBox3D();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectInBox3D_message_members = {
  ...
  ObjectInBox3D_init_function,  // function to initialize message memory (memory has to be allocated)
  ObjectInBox3D_fini_function  // function to terminate message instance (will not free memory)
};
