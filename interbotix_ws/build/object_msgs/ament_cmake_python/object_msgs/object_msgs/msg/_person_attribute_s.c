...
bool object_msgs__msg__person_attribute__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_msgs.msg._person_attribute.PersonAttribute", full_classname_dest, 49) == 0);
  }
  object_msgs__msg__PersonAttribute * ros_message = _ros_message;
  {  // attribute
...
{
  /* NOTE(esteve): Call constructor of PersonAttribute */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_msgs.msg._person_attribute");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PersonAttribute");
