...
bool object_msgs__msg__object_in_mask__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_msgs.msg._object_in_mask.ObjectInMask", full_classname_dest, 44) == 0);
  }
  object_msgs__msg__ObjectInMask * ros_message = _ros_message;
  {  // object_name
  ...
  {  // mask_array
    PyObject * field = PyObject_GetAttrString(_pymsg, "mask_array");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->mask_array.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'mask_array'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ObjectInMask */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_msgs.msg._object_in_mask");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectInMask");
  ...
  {  // mask_array
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "mask_array");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->mask_array.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->mask_array.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->mask_array.size * sizeof(float));
      assert(data != NULL);
