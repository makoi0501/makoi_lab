...
class Metaclass_ObjectInBox(type):
    """Metaclass of message 'ObjectInBox'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__object_in_box
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__object_in_box
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__object_in_box
            cls._TYPE_SUPPORT = module.type_support_msg__msg__object_in_box
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__object_in_box
...
class ObjectInBox(metaclass=Metaclass_ObjectInBox):
    """Message class 'ObjectInBox'."""
