...
class Metaclass_ObjectsInBoxes(type):
    """Metaclass of message 'ObjectsInBoxes'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__objects_in_boxes
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__objects_in_boxes
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__objects_in_boxes
            cls._TYPE_SUPPORT = module.type_support_msg__msg__objects_in_boxes
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__objects_in_boxes
...
class ObjectsInBoxes(metaclass=Metaclass_ObjectsInBoxes):
    """Message class 'ObjectsInBoxes'."""
    ...
    _fields_and_field_types = {
        ...
        'objects_vector': 'sequence<object_msgs/ObjectInBox>',
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'objects_vector' field must be a set or sequence and each value of type 'ObjectInBox'"
