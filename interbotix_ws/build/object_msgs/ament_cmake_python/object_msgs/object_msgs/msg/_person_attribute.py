...
class Metaclass_PersonAttribute(type):
    """Metaclass of message 'PersonAttribute'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__person_attribute
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__person_attribute
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__person_attribute
            cls._TYPE_SUPPORT = module.type_support_msg__msg__person_attribute
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__person_attribute
...
class PersonAttribute(metaclass=Metaclass_PersonAttribute):
    """Message class 'PersonAttribute'."""
