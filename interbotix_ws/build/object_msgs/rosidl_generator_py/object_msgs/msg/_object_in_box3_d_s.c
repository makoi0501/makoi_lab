...
bool object_msgs__msg__object_in_box3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_msgs.msg._object_in_box3_d.ObjectInBox3D", full_classname_dest, 47) == 0);
  }
  object_msgs__msg__ObjectInBox3D * ros_message = _ros_message;
  {  // object
  ...
  {  // min
    ...
    if (!geometry_msgs__msg__point32__convert_from_py(field, &ros_message->min)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // max
    ...
    if (!geometry_msgs__msg__point32__convert_from_py(field, &ros_message->max)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ObjectInBox3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_msgs.msg._object_in_box3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectInBox3D");
  ...
  {  // min
    PyObject * field = NULL;
    field = geometry_msgs__msg__point32__convert_to_py(&ros_message->min);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // max
    PyObject * field = NULL;
    field = geometry_msgs__msg__point32__convert_to_py(&ros_message->max);
    if (!field) {
      return NULL;
    }
    {
