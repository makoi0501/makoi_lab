...
bool object_msgs__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_msgs.msg._object.Object", full_classname_dest, 30) == 0);
  }
  object_msgs__msg__Object * ros_message = _ros_message;
  {  // object_name
...
PyObject * object_msgs__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_msgs.msg._object");
