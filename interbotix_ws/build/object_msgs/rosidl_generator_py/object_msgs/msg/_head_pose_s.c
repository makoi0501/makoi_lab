...
bool object_msgs__msg__head_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_msgs.msg._head_pose.HeadPose", full_classname_dest, 35) == 0);
  }
  object_msgs__msg__HeadPose * ros_message = _ros_message;
  {  // yaw
...
{
  /* NOTE(esteve): Call constructor of HeadPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_msgs.msg._head_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HeadPose");
