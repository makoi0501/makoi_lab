...
bool object_msgs__msg__vehicle_attribs__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_msgs.msg._vehicle_attribs.VehicleAttribs", full_classname_dest, 47) == 0);
  }
  object_msgs__msg__VehicleAttribs * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of VehicleAttribs */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_msgs.msg._vehicle_attribs");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleAttribs");
