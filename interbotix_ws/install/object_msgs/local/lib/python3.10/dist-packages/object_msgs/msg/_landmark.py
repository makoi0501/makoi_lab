...
class Landmark(metaclass=Metaclass_Landmark):
    ...
    _fields_and_field_types = {
        'landmark_points': 'sequence<geometry_msgs/Point>',
    ...
    def __init__(self, **kwargs):
        ...
        self.landmark_points = kwargs.get('landmark_points', [])
        from sensor_msgs.msg import RegionOfInterest
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.landmark_points != other.landmark_points:
            return False
    ...
    def landmark_points(self):
        """Message field 'landmark_points'."""
        return self._landmark_points

    @landmark_points.setter
    def landmark_points(self, value):
        if __debug__:
            from geometry_msgs.msg import Point
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'landmark_points' field must be a set or sequence and each value of type 'Point'"
        self._landmark_points = value
