...
object_msgs__srv__ClassifyObject_Request__init(object_msgs__srv__ClassifyObject_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->image_path)) {
    object_msgs__srv__ClassifyObject_Request__fini(msg);
    return false;
  }
  return true;
}
...
object_msgs__srv__ClassifyObject_Request__create()
{
  ...
  object_msgs__srv__ClassifyObject_Request * msg = (object_msgs__srv__ClassifyObject_Request *)allocator.allocate(sizeof(object_msgs__srv__ClassifyObject_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(object_msgs__srv__ClassifyObject_Request));
  bool success = object_msgs__srv__ClassifyObject_Request__init(msg);
  if (!success) {
...
object_msgs__srv__ClassifyObject_Request__Sequence__init(object_msgs__srv__ClassifyObject_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__srv__ClassifyObject_Request * data = NULL;

  if (size) {
    data = (object_msgs__srv__ClassifyObject_Request *)allocator.zero_allocate(size, sizeof(object_msgs__srv__ClassifyObject_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = object_msgs__srv__ClassifyObject_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        object_msgs__srv__ClassifyObject_Request__fini(&data[i - 1]);
      }
...
object_msgs__srv__ClassifyObject_Request__Sequence__fini(object_msgs__srv__ClassifyObject_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      object_msgs__srv__ClassifyObject_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__srv__ClassifyObject_Request__Sequence * array = (object_msgs__srv__ClassifyObject_Request__Sequence *)allocator.allocate(sizeof(object_msgs__srv__ClassifyObject_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = object_msgs__srv__ClassifyObject_Request__Sequence__init(array, size);
  if (!success) {
...
object_msgs__srv__ClassifyObject_Request__Sequence__destroy(object_msgs__srv__ClassifyObject_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    object_msgs__srv__ClassifyObject_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
object_msgs__srv__ClassifyObject_Request__Sequence__are_equal(const object_msgs__srv__ClassifyObject_Request__Sequence * lhs, const object_msgs__srv__ClassifyObject_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!object_msgs__srv__ClassifyObject_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  object_msgs__srv__ClassifyObject_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(object_msgs__srv__ClassifyObject_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    object_msgs__srv__ClassifyObject_Request * data =
      (object_msgs__srv__ClassifyObject_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!object_msgs__srv__ClassifyObject_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          object_msgs__srv__ClassifyObject_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!object_msgs__srv__ClassifyObject_Request__copy(
...
object_msgs__srv__ClassifyObject_Response__init(object_msgs__srv__ClassifyObject_Response * msg)
{
  ...
  // objects
  if (!object_msgs__msg__Objects__init(&msg->objects)) {
    object_msgs__srv__ClassifyObject_Response__fini(msg);
    return false;
  }
  return true;
}
...
object_msgs__srv__ClassifyObject_Response__fini(object_msgs__srv__ClassifyObject_Response * msg)
{
  ...
  // objects
  object_msgs__msg__Objects__fini(&msg->objects);
}
...
object_msgs__srv__ClassifyObject_Response__are_equal(const object_msgs__srv__ClassifyObject_Response * lhs, const object_msgs__srv__ClassifyObject_Response * rhs)
{
  ...
  // objects
  if (!object_msgs__msg__Objects__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__srv__ClassifyObject_Response * msg = (object_msgs__srv__ClassifyObject_Response *)allocator.allocate(sizeof(object_msgs__srv__ClassifyObject_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(object_msgs__srv__ClassifyObject_Response));
  bool success = object_msgs__srv__ClassifyObject_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
object_msgs__srv__ClassifyObject_Response__Sequence__init(object_msgs__srv__ClassifyObject_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__srv__ClassifyObject_Response * data = NULL;

  if (size) {
    data = (object_msgs__srv__ClassifyObject_Response *)allocator.zero_allocate(size, sizeof(object_msgs__srv__ClassifyObject_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = object_msgs__srv__ClassifyObject_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        object_msgs__srv__ClassifyObject_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
object_msgs__srv__ClassifyObject_Response__Sequence__fini(object_msgs__srv__ClassifyObject_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      object_msgs__srv__ClassifyObject_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  object_msgs__srv__ClassifyObject_Response__Sequence * array = (object_msgs__srv__ClassifyObject_Response__Sequence *)allocator.allocate(sizeof(object_msgs__srv__ClassifyObject_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = object_msgs__srv__ClassifyObject_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
object_msgs__srv__ClassifyObject_Response__Sequence__destroy(object_msgs__srv__ClassifyObject_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    object_msgs__srv__ClassifyObject_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
object_msgs__srv__ClassifyObject_Response__Sequence__are_equal(const object_msgs__srv__ClassifyObject_Response__Sequence * lhs, const object_msgs__srv__ClassifyObject_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!object_msgs__srv__ClassifyObject_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  object_msgs__srv__ClassifyObject_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(object_msgs__srv__ClassifyObject_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    object_msgs__srv__ClassifyObject_Response * data =
      (object_msgs__srv__ClassifyObject_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!object_msgs__srv__ClassifyObject_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          object_msgs__srv__ClassifyObject_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!object_msgs__srv__ClassifyObject_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
