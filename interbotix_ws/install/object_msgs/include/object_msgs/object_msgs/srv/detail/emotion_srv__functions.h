...
#ifndef OBJECT_MSGS__SRV__DETAIL__EMOTION_SRV__FUNCTIONS_H_
#define OBJECT_MSGS__SRV__DETAIL__EMOTION_SRV__FUNCTIONS_H_
...
/// Initialize srv/EmotionSrv message.
/**
...
/// Finalize srv/EmotionSrv message.
/**
...
/// Create srv/EmotionSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * object_msgs__srv__EmotionSrv_Request__init().
...
/// Destroy srv/EmotionSrv message.
/**
 * It calls
 * object_msgs__srv__EmotionSrv_Request__fini()
...
/// Check for srv/EmotionSrv message equality.
/**
...
/// Initialize array of srv/EmotionSrv messages.
/**
...
/// Finalize array of srv/EmotionSrv messages.
/**
 * It calls
 * object_msgs__srv__EmotionSrv_Request__fini()
...
/// Create array of srv/EmotionSrv messages.
/**
 * It allocates the memory for the array and calls
 * object_msgs__srv__EmotionSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/EmotionSrv messages.
/**
 * It calls
 * object_msgs__srv__EmotionSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/EmotionSrv message array equality.
/**
...
/// Copy an array of srv/EmotionSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * object_msgs__srv__EmotionSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_object_msgs
...
/**
 * It calls
 * object_msgs__srv__EmotionSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_object_msgs
...
/**
 * It allocates the memory for the array and calls
 * object_msgs__srv__EmotionSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_object_msgs
...
/**
 * It calls
 * object_msgs__srv__EmotionSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OBJECT_MSGS__SRV__DETAIL__EMOTION_SRV__FUNCTIONS_H_
