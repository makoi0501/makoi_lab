...
#ifndef OBJECT_MSGS__MSG__DETAIL__AGE_GENDER__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__AGE_GENDER__STRUCT_HPP_
...
struct AgeGender_
{
  ...
  explicit AgeGender_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit AgeGender_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : gender(_alloc),
    roi(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
...
#endif  // OBJECT_MSGS__MSG__DETAIL__AGE_GENDER__STRUCT_HPP_
