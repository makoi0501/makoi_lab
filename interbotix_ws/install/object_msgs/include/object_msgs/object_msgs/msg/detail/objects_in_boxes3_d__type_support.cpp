...
void ObjectsInBoxes3D_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) object_msgs::msg::ObjectsInBoxes3D(_init);
}

void ObjectsInBoxes3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_msgs::msg::ObjectsInBoxes3D *>(message_memory);
  typed_message->~ObjectsInBoxes3D();
}
...
void fetch_function__ObjectsInBoxes3D__objects_in_boxes(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const object_msgs::msg::ObjectInBox3D *>(
    get_const_function__ObjectsInBoxes3D__objects_in_boxes(untyped_member, index));
  auto & value = *reinterpret_cast<object_msgs::msg::ObjectInBox3D *>(untyped_value);
  value = item;
}

void assign_function__ObjectsInBoxes3D__objects_in_boxes(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<object_msgs::msg::ObjectInBox3D *>(
    get_function__ObjectsInBoxes3D__objects_in_boxes(untyped_member, index));
  const auto & value = *reinterpret_cast<const object_msgs::msg::ObjectInBox3D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectsInBoxes3D_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__ObjectsInBoxes3D__objects_in_boxes,  // fetch(index, &value) function pointer
    assign_function__ObjectsInBoxes3D__objects_in_boxes,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectsInBoxes3D_message_members = {
  ...
  ObjectsInBoxes3D_init_function,  // function to initialize message memory (memory has to be allocated)
  ObjectsInBoxes3D_fini_function  // function to terminate message instance (will not free memory)
};
