...
void Reidentification_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) object_msgs::msg::Reidentification(_init);
}

void Reidentification_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_msgs::msg::Reidentification *>(message_memory);
  typed_message->~Reidentification();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Reidentification_message_members = {
  ...
  Reidentification_init_function,  // function to initialize message memory (memory has to be allocated)
  Reidentification_fini_function  // function to terminate message instance (will not free memory)
};
