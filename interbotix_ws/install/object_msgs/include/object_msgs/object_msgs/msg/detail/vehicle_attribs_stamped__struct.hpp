...
#ifndef OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS_STAMPED__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS_STAMPED__STRUCT_HPP_
...
struct VehicleAttribsStamped_
{
  ...
  explicit VehicleAttribsStamped_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit VehicleAttribsStamped_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _vehicles_type =
    std::vector<object_msgs::msg::VehicleAttribs_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::VehicleAttribs_<ContainerAllocator>>>;
  ...
  Type & set__vehicles(
    const std::vector<object_msgs::msg::VehicleAttribs_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::VehicleAttribs_<ContainerAllocator>>> & _arg)
  {
    this->vehicles = _arg;
    return *this;
  }
...
#endif  // OBJECT_MSGS__MSG__DETAIL__VEHICLE_ATTRIBS_STAMPED__STRUCT_HPP_
