...
#ifndef OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_BOX3_D__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_BOX3_D__STRUCT_HPP_
...
struct ObjectInBox3D_
{
  ...
  explicit ObjectInBox3D_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : object(_init),
    roi(_init),
    min(_init),
    max(_init)
  ...
  explicit ObjectInBox3D_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : object(_alloc, _init),
    roi(_alloc, _init),
    min(_alloc, _init),
    max(_alloc, _init)
...
#endif  // OBJECT_MSGS__MSG__DETAIL__OBJECT_IN_BOX3_D__STRUCT_HPP_
