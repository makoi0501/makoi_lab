...
#ifndef OBJECT_MSGS__MSG__DETAIL__PERF_VALUE__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__PERF_VALUE__STRUCT_HPP_
...
struct PerfValue_
{
  ...
  explicit PerfValue_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit PerfValue_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
...
#endif  // OBJECT_MSGS__MSG__DETAIL__PERF_VALUE__STRUCT_HPP_
