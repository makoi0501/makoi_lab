...
#ifndef OBJECT_MSGS__MSG__DETAIL__OBJECTS__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__OBJECTS__STRUCT_HPP_
...
struct Objects_
{
  ...
  using _objects_vector_type =
    std::vector<object_msgs::msg::Object_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Object_<ContainerAllocator>>>;
  ...
  Type & set__objects_vector(
    const std::vector<object_msgs::msg::Object_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Object_<ContainerAllocator>>> & _arg)
  {
...
#endif  // OBJECT_MSGS__MSG__DETAIL__OBJECTS__STRUCT_HPP_
