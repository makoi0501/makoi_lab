...
#ifndef OBJECT_MSGS__MSG__DETAIL__HEAD_POSE__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__HEAD_POSE__STRUCT_HPP_
...
struct HeadPose_
{
  ...
  explicit HeadPose_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_init)
  {
  ...
  explicit HeadPose_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : roi(_alloc, _init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
...
#endif  // OBJECT_MSGS__MSG__DETAIL__HEAD_POSE__STRUCT_HPP_
