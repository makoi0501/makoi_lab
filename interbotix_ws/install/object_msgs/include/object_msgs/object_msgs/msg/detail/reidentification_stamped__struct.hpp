...
#ifndef OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION_STAMPED__STRUCT_HPP_
#define OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION_STAMPED__STRUCT_HPP_
...
struct ReidentificationStamped_
{
  ...
  explicit ReidentificationStamped_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit ReidentificationStamped_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _reidentified_vector_type =
    std::vector<object_msgs::msg::Reidentification_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Reidentification_<ContainerAllocator>>>;
  ...
  Type & set__reidentified_vector(
    const std::vector<object_msgs::msg::Reidentification_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<object_msgs::msg::Reidentification_<ContainerAllocator>>> & _arg)
  {
...
#endif  // OBJECT_MSGS__MSG__DETAIL__REIDENTIFICATION_STAMPED__STRUCT_HPP_
