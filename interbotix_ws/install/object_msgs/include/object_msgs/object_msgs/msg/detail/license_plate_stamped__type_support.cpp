...
void LicensePlateStamped_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) object_msgs::msg::LicensePlateStamped(_init);
}

void LicensePlateStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_msgs::msg::LicensePlateStamped *>(message_memory);
  typed_message->~LicensePlateStamped();
}
...
void fetch_function__LicensePlateStamped__licenses(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const object_msgs::msg::LicensePlate *>(
    get_const_function__LicensePlateStamped__licenses(untyped_member, index));
  auto & value = *reinterpret_cast<object_msgs::msg::LicensePlate *>(untyped_value);
  value = item;
}

void assign_function__LicensePlateStamped__licenses(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<object_msgs::msg::LicensePlate *>(
    get_function__LicensePlateStamped__licenses(untyped_member, index));
  const auto & value = *reinterpret_cast<const object_msgs::msg::LicensePlate *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LicensePlateStamped_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__LicensePlateStamped__licenses,  // fetch(index, &value) function pointer
    assign_function__LicensePlateStamped__licenses,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LicensePlateStamped_message_members = {
  ...
  LicensePlateStamped_init_function,  // function to initialize message memory (memory has to be allocated)
  LicensePlateStamped_fini_function  // function to terminate message instance (will not free memory)
};
